(function () {
    ...
    Object.assign(english, {
        ...
        '检测到 {count} 个可用逻辑线程；搜索力度会按路径评分和候选数量调整搜索宽度。':'Detected {count} logical threads. Search effort adjusts width based on path scores and competing candidates.',
        ...
        '自动探索':'Auto Decode','支持的编码与密码':'Supported Encodings and Ciphers','全自动多层解密工具':'Automatic Multi-layer Decoder','看懂一切暗语。 *本标语是产品目标，不是效果保证。':'Make sense of every secret message. *This is a product goal, not a guarantee.','待分析文本':'Text to analyze','粘贴各类编码、密码甚至多层嵌套密码……':'Paste an encoding, cipher, or even a multi-layer puzzle…','最大深度':'Maximum depth','节点预算':'Node budget','最大深度越高，搜索越倾向继续探索看似明文的中间结果。':'Higher maximum depths make the search more willing to explore intermediate results that look like plaintext.','开始解密':'Start decoding','停止':'Stop','启用 ACG Name':'Enable ACG Name','？可能的ACG Name：':'Possible ACG Name? ',
